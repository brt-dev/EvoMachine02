	...
	<div id="header">
		...
		<label>alphaware</label>
			...
			<ul>
				...
				<li>Welcome:&nbsp;&nbsp;&nbsp;<a href="#profile" href  data-toggle="modal"><i class="icon-user icon-white"></i>&nbsp;</a></li>
			</ul>
	</div>
				...
				<div class="modal-header">
					...
					<form method="post">
						<center>
							<table>
								<tr>
									<td class="profile">Name:</td><td class="profile">&nbsp;&nbsp;</td>
								</tr>
								<tr>
									<td class="profile">Address:</td><td class="profile"></td>
								</tr>
								<tr>
									<td class="profile">Country:</td><td class="profile"></td>
								</tr>
								<tr>
									<td class="profile">ZIP Code:</td><td class="profile"></td>
								</tr>
								<tr>
									<td class="profile">Mobile Number:</td><td class="profile"></td>
								</tr>
								<tr>
									<td class="profile">Telephone Number:</td><td class="profile"></td>
								</tr>
								<tr>
									<td class="profile">Email:</td><td class="profile"></td>
								</tr>
							</table>
						</center>
					</div>
				<div class="modal-footer">
					<a href="account.php?id="><input type="button" class="btn btn-success" name="edit" value="Edit Account"></a>
	...
	<div class="nav">	
			 <ul>
				...
				<li><a href="faqs1.php"><i class="icon-question-sign"></i>FAQs</a></li>
						...
						<div>
					<center>
						<img class="img-polaroid" style="width:400px; height:350px;" src="photo/">
						<h2 class="text-uppercase bg-primary"></h2>
						<h3 class="text-uppercase">Php </h3>
						<h3 class="text-uppercase">Size: </h3>
						<a href='cart.php?id=/alphaware/photo/.php&action=add'><input type='submit' class='btn btn-inverse' name='add' value='Add to Cart'></a> &nbsp;  <a href='product1.php'><button class='btn btn-inverse'>Back</button></a> 					</center>
				</div>
